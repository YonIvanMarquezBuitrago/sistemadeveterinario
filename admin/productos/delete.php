...
?>
    ...
    <div class="container-fluid">
        <h1>Producto a Eliminar: <?= $nombre_producto; ?></h1>
        <div class="row">
            <div class="col-md-12">
                <div class="card card card-danger">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <form action="<?= APP_URL; ?>/app/controllers/productos/delete.php" method="post">
                                        <!--Se llama el id_producto a eliminar-->
                                        <input type="text" value="<?=$id_producto;?>" name="id_producto" hidden="hidden">
                                        <!--Se llama la imagen a eliminar-->
                                        <input type="text" value="<?=$imagen;?>" name="image_text" hidden="hidden">
