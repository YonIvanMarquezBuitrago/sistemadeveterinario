...
<div class="container-fluid">
    <h1>Producto a Actualizar: <?= $nombre_producto; ?></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <h3 class="card-title"><b>Actualizar Datos del Producto</b></h3>
                </div>
                <div class="card-body" style="display: block;">
                    <!--Cuando se trabaja con archivos, se debe colocar la propiedad enctype="multipart/form-data"-->
                    <form action="<?= APP_URL; ?>/app/controllers/productos/update.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form group">
                                            ...
                                            <!--Llamado del id_producto-->
                                            <input type="text" name="id_producto" value="<?= $id_producto; ?>" hidden="hidden">
                                            <!--Llamado de la imagen-->
                                            <input type="text" name="image_text" value="<?= $imagen; ?>" hidden="hidden">
                                            <!--Se pone el código 2 veces, uno sin name deshabilitado (el que se ve) y otro que tiene el name pero está oculto-->
                                            <input type="text" class="form-control" value="P-<?= $codigo; ?>" disabled>
                                            <input type="text" name="codigo" class="form-control" value="P-<?= $codigo; ?>" hidden="hidden">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form group">
                            ...
                            <div class="col-md-3"><!--Columna a la Derecha-->
                                <div class="form-group">
                                    ...
                                    <center>
                                        <output id="list">
                                            <img src="<?= APP_URL . "/public/images/productos/" . $imagen; ?>" width="100%" alt="<?= $nombre_producto; ?>">
                                        </output>
                                    </center>
